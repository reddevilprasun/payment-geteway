        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              ...
              <div className="prose max-w-none">
                <p className="text-gray-600 mb-6">
                  Welcome to the UPI Gateway API documentation. Our RESTful API
                  allows you to integrate secure payment processing into your
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <code className="text-blue-800 bg-blue-100 px-2 py-1 rounded overflow-x-auto break-all">
                    https://upigeteway.vercel.app/
                  </code>
                </div>
              </div>
            </section>
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                All API requests require authentication using API keys. Include
    ...
    "msg": "success"
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                ...
                payment events. Configure your webhook URL in the dashboard.
              </p>
  ...
  "signature": "sha256=abc123def456..."
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-blue-800 text-sm">
                    Always verify webhook signatures to ensure the request is
                    from our servers.
                  </p>
                </div>
              </div>
...
?>`}
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Our API uses conventional HTTP response codes to indicate the
